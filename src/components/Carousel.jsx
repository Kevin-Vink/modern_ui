    ...
    <div className="w-full h-full flex flex-col items-center justify-center gap-y-6">
      <div className="w-full h-full flex items-center relative">
        <div className="w-slide h-fit relative translate-x-20">
          ...
          <div className="w-full rounded-2xl z-0 text-white p-8 h-[23rem] flex flex-col gap-y-2 justify-between group relative cursor-pointer shadow-slide-drop">
            <div
            ...
            <div className="flex z-20 flex-col gap-y-12 max-w-[14rem]">
              <span
                className="py-1 px-2 rounded group-hover:bg-blue-600 transition-colors font-medium tracking-widest w-fit text-xs bg-blue-700 uppercase"
              >
                industry update
              </span>
        ...
        <div className="w-slide h-fit relative">
          ...
          <div className="w-full z-10 text-white p-8 h-[28rem] flex flex-col gap-y-2 justify-between group relative cursor-pointer shadow-slide-drop">
            <div
              className="absolute z-10 top-0 left-0 w-full h-full bg-cover rounded-2xl shadow-slide"
              style={{ backgroundImage: 'url(./images/2.jpg)' }}
            />
            <div className="flex z-20 flex-col gap-y-12 max-w-[14rem]">
              <span className="py-1 px-2 rounded group-hover:bg-blue-600 transition-colors font-medium tracking-widest w-fit text-xs bg-blue-700 uppercase">
                product update
              </span>
        ...
        <div className="w-slide h-fit relative -translate-x-20">
          <div className="absolute z-10 top-0 left-0 w-full h-full bg-woodsmoke/75" />
          <div className="w-full z-0 text-white p-8 h-[23rem] flex flex-col gap-y-2 justify-between group relative cursor-pointer shadow-slide-drop">
            <div
              className="absolute z-10 top-0 left-0 w-full h-full bg-cover rounded-2xl shadow-slide"
